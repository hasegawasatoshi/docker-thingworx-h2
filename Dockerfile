...
RUN addgroup --system tomcat8 --quiet \
    ...
    && echo "export JAVA_OPTS=\"-Djava.awt.headless=true -Djava.net.preferIPv4Stack=true -Dserver -Dd64 -XX:+UseNUMA -XX:+UseConcMarkSweepGC -Dfile.encoding=UTF-8\"" > ./bin/setenv.sh \
